...
function Init() {
    ...
    /**/
    document.querySelector("#add-form").addEventListener("submit", AddStudent);
    ...
    function ShowStudents() {
        ...
        people.forEach(function (person) {
            html += "<tr data-group='" + person.group + "'><td>" + person.name.last
             ...
             <button type='button' class='btn' data-edit data-id='${person._id}'>
        ...
        tbody.querySelectorAll("[data-edit]").forEach(function (btn) {
            btn.addEventListener("click", ShowEditStudentForm);
        });
    }
    ...
    function PrepareForm() {
        ...
        let html = "";
        for (let n in groups) {
            html += `<option value="${n}">Группа ${n}</option>`;
        }
